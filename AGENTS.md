...
- For Hermes runtime image deployment, load `skills/hermes-runtime-deploy/SKILL.md`. In this repo,
  "deployment" means product/wrapper image rollout through `dev-hermes-img`, `oc20`, and explicit
  customer targets; it does not mean installing or updating `opsctl`.
